...
Google のアカウントがある方はGithub上のノートブックをそのままColab上で実行することもできます。（*デフォルトで提供されていないライブラリもあるのでその場合は別途環境を作る必要があります。）ここでは、以前Mishima.sykで実施したScikit-learnハンズオンのノートブックを開いてみます。
=======
...
>>>>>>> 44256aaabbd20d3ae312418c0ebad65242c3d9b7
